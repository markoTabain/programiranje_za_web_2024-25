...
from wtforms import StringField, SubmitField, TextAreaField, DateField, FileField, RadioField, SelectField, PasswordField, BooleanField
...
class BlogPostForm(FlaskForm):
    ...
    status = SelectField('Status', choices=[('draft', 'Skica'), ('published', 'Objavljeno')], default='draft')
